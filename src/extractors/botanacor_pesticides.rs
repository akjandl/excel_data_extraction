...
pub fn get_extractors() -> Vec<SheetExtractor> {
    ...
    let master_list = SheetExtractor::Multi(SheetSelector {
        col_names: vec!["Customer Name", "Sample Name", "Report Type"],
    ...
    let results = SheetExtractor::Single(Sheet {
        ...
        col_indexers: vec![
            ...
            ColIndexer::ColFindFunc(find_col("Dichlorovos")),
            ...
            ColIndexer::ColFindFunc(find_col("Paclobutrazole")),
            ...
            ColIndexer::ColFindFunc(find_col("Clofentazine")),
